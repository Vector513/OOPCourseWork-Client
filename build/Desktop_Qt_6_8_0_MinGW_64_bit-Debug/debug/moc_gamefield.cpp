...
void GameField::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onGoldBoxClicked((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        ...
        {
            using _t = void (GameField::*)(int );
            if (_t _q_method = &GameField::goldBoxClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GameField::goldBoxClicked(int _t1)
{
